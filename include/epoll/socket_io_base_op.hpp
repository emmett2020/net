 ...
 */
#ifndef EPOLL_SOCKET_IO_BASE_OP_HPP_
#define EPOLL_SOCKET_IO_BASE_OP_HPP_
 ...
 public:
  struct __t : public stdexec::__immovable,
    ...
    struct op_vtable {
      ...
      // The `ec_` should be assigned to indicate whether the operation is
      // complete.
      void (*perform)(__t*) noexcept = nullptr;  // NOLINT

      // This operation is complete. Notify the downstream receiver based on the
      // value of `ec_`.
      void (*complete)(__t*) noexcept = nullptr;  // NOLINT
    };
    ...
    // Constructor.
    __t(receiver_t receiver, basic_socket<Protocol>& socket,
        const op_vtable& vtable, op_type otype) noexcept
...
#endif  // EPOLL_SOCKET_IO_BASE_OP_HPP_
