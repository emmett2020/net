// #ifndef NET_SRC_IS_BUFFER_SEQUENCE_HPP_
// #define NET_SRC_IS_BUFFER_SEQUENCE_HPP_
...
// char (&buffer_sequence_begin_helper(
//     T* t,
//     typename enable_if<!is_same<decltype(buffer_sequence_begin(*t)), void>::value>::type*))[2];
...
// template <typename T>
// char (&buffer_sequence_end_helper(
//     T* t, typename enable_if<!is_same<decltype(buffer_sequence_end(*t)),
//     void>::value>::type*))[2];
...
//               && sizeof(consume_memfn_helper<T>(0)) != 1 && sizeof(prepare_memfn_helper<T>(0)) !=
//               1
...
// template <typename T>
// struct is_dynamic_buffer_v1_base
