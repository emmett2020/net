...
// #ifndef SRC_NET_IP_BASIC_RESOLVER_H_
// #define SRC_NET_IP_BASIC_RESOLVER_H_
...
// #include "basic_resolver_query.h"
// #include "basic_resolver_results.h"
...
//       typename constraint<is_convertible<ExecutionContext&, execution_context&>::value>::type =
//       0) : impl_(0, 0, context) {}
...
//    */
//   template <typename Executor1>
//   typename constraint<is_convertible<Executor1, Executor>::value, basic_resolver&>::type
//   operator=(
...
//                 ResolveToken ASIO_DEFAULT_COMPLETION_TOKEN_TYPE(executor_type)>
//   ASIO_INITFN_AUTO_RESULT_TYPE_PREFIX(ResolveToken, void(asio::error_code, results_type))
//   async_resolve(const query& q,
//                 ASIO_MOVE_ARG(ResolveToken) token ASIO_DEFAULT_COMPLETION_TOKEN(executor_type))
//       ASIO_INITFN_AUTO_RESULT_TYPE_SUFFIX(
//           (asio::async_initiate<ResolveToken, void(asio::error_code, results_type)>(
...
// #endif  // SRC_NET_IP_BASIC_RESOLVER_H_
