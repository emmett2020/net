#ifndef NET_SRC_SOCKET_BASE_HPP_
#define NET_SRC_SOCKET_BASE_HPP_
...
#include "stdexec/include/exec/linux/safe_file_descriptor.hpp"
...
class socket_base {
 public:
  ...
  // Wait types. For use with basic_socket::wait() and basic_socket::async_wait().
  ...
  using receive_low_water_mark = socket_option::integer<SOL_SOCKET, SO_RCVLOWAT>;
  ...
  using enable_connection_aborted =
      socket_option::boolean<custom_socket_option_level, enable_connection_aborted_option>;
...
#endif  // NET_SRC_SOCKET_BASE_HPP_
