#ifndef NET_SRC_ERROR_HPP_
#define NET_SRC_ERROR_HPP_
...
struct system_error2::quick_status_code_from_enum<net::network_errc>
    : public system_error2::quick_status_code_from_enum_defaults<net::network_errc> {
  ...
  static constexpr const auto domain_uuid = "{0768dead-0f2d-d0c6-14cb-6f82f353598e}";
...
inline constexpr system_error2::quick_status_code_from_enum_code<net::network_errc> status_code(
    net::network_errc ec) {
